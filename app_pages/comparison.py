"""Comparison page — sensors against each other (plan §5.4).
...
st.title(":material/compare_arrows: Comparison")
st.caption("Compare one measure across several sensors over a shared time range.")
